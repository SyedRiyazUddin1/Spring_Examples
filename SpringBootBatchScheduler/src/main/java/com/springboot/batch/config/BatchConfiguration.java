...
import com.springboot.batch.listener.JobCompletionNotificationListener;
import com.springboot.batch.model.Person;
import com.springboot.batch.processor.PersonItemProcessor;
...
public class BatchConfiguration {
	...
	/**
	 * The below bean looks for the person.csv file, parses each line items with
	 * enough info to turn into the Person object
	 */
	@Bean
