...
<body>
	...
	<%@page import="com.jspservlet.dao.StudentDetails"%>
	<%@page import="java.util.Iterator"%>

	<%
		ArrayList<StudentDetails> studentList = (ArrayList) request.getAttribute("stuList");
	%>
	<%--Assigning ArrayList object containing Student data to the local object --%>

	<strong><a
		href="<%=request.getContextPath()%>/LoginServlet?type=getDetails">Show
			Student Details</a></strong>
	<br></br>
